...
//	@TestDoc(dateDocumented="18/07/12", 
//			testCaseID="创建应用-电商平台-IOS, 游戏平台-Android, 其他平台-H5",
//			testObjective="测试创建不同应用的基本测试 - 非小程序")
//	public void testCreateApplication() throws Exception{
//		
//		//String createApplicationFile = "应用管理/testCreateApps.xlsx";
//		String createApplicationFile = "d:/testAppSearch.xlsx";
